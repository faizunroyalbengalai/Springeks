...
locals {
  ...
  _spring_ds_url  = "jdbc:postgresql://${aws_db_instance.main.address}:${local._rds_port}/${local._rds_db_name}"
  _spring_ds_user = local._rds_user
  _spring_ds_pass = var.rds_db_password
